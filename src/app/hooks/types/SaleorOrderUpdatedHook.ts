export interface SaleorOrderUpdatedHook {
  type: string;
  id: string;
  channel: Channel;
  ...
  created: Date;
  original: string;
  lines: SaleorOrderUpdatedHookLine[];
...
export interface FulfillmentLine {
  ...
  undiscounted_unit_price_net: string;
  undiscounted_unit_price_gross: string;
...
export interface SaleorOrderUpdatedHookLine {
  type: string;
  id: string;
  product_variant_id: string;
  total_price_net_amount: string;
